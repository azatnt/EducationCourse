...
namespace EducationCourse.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "CourseId,Title,Description,Hours,Image,CategoryId,InstructorId")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "CourseId,Title,Description,Hours,Image,CategoryId,InstructorId")] Course course)
        {
            if (ModelState.IsValid)
            {
